...
class Critic(nn.Module):
    '''Decides whether an image is "real" or generated by the "generator".'''
    def __init__(self, image_size, image_channel_size, channel_size=64):
        # configurations
        super().__init__()
...
class Generator(nn.Module):
    def __init__(self, z_size, image_size, image_channel_size, channel_size=64):
        # configurations
        super().__init__()
        self.z_size = z_size
        self.image_size = image_size
